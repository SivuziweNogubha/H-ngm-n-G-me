...
public class AnswerTest {
    ...
    public void giveAHint() {
        Answer solution = new Answer("feed");                                                           // <1>
        Answer lastAnswer = new Answer("fee_");                                                         // <2>
        Answer hint = solution.getHint(lastAnswer, 'd');                                                // <3>
        assertEquals(new Answer("feed"), hint);
    }
    @Test
